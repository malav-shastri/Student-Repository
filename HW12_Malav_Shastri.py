...
DB_FILe: str = "Student-Repository.db"
...
class Major:
    ...
    def result_return_major(self):
        """This function is use to return the data
        used in preety table of major summary"""
...
class Instructor:
    ...
    def result_return_instructor(self):
        """Use to return the final value of the class instructor
         and this value is used and printed
         in pretty table of instructor summary"""
...
class Repository:
    ...
    def check_student_data(self):
        """This function read the students.txt
        file and fill values in self._students"""
    ...
    def check_grades_data(self):
        """This function read the grades.txt file and fill values in
         both self._students and self._instructors"""
    ...
    def check_majors_data(self):
        """This function reads the majors.txt file and is use to fill the /
        value of self.mainmajor"""
    ...
    def cal_required_elective_courses_forstudent(self):
        """This function is use to calculate required
        and elective courses left for a particular student"""
        path1: str = os.path.join(self._path, "students.txt")
        try:
            open_file1 = file_reader(path1, fields=3, sep="\t", header=True)
            for cwid, name, major in open_file1:
...
def main():
    Repository(r"/Users/malavshastri/Desktop/assignment12")
    ...
    def final_web_table() -> str:
        ...
        final_data: List[Dict[str, str]] = [{"Student": student, "CWID": cwid,
                                             "Course": course, "Grade": grade,
                                             "Instructor": instructor}
                                            for student, cwid, course, grade,
