...
class Major:
    ...
    def result_return_major(self):
        """Function is use to return the data used in
           preety table of major summary"""
...
class Student:
    ...
    def __init__(self, cwid: str, name: str, major: str):
        ...
        self._name: str = name
        self._major: str = major
        self._course: Dict[str, str] = dict()  # key=coursename, values=grade
        self._courseelective: List[str] = list()
        self._courserequired: List[str] = list()

    def comp_courses(self, course: str, grade: str):
        """Use to get completed courses in
           form of list as keys for this assignment"""
        self._course[course]: Dict[str, int] = general_grades[grade]

    def add_courses(self, course: Any):
        """This function is use know which required and eletive
           courses is left for a particular student to complete"""
    ...
    and this value is used and printed in pretty table of student summary"""
        ...
        return [self._cwid, self._name, sorted(self._course.keys()),
                sorted(self._courserequired), sorted(self._courseelective),
                gpa]
...
class Instructor:
    ...
    def add_num_of_students(self, course: str):
        """This function is use to keep the count of number of
           students taken courses of a particular instructor"""
        self._courses[course] += 1

    def result_return_instructor(self):
        """Use to return the final value of the class instructor
         and this value is used and printed in pretty table
         of instructor summary"""
...
class Repository:
    ...
    def check_student_data(self):
        """This function read the students.txt file and fill
           values in self._students"""
        path1: str = os.path.join(self._path, "students.txt")
        try:
            open_file1 = file_reader(path1, fields=3, sep="\t", header=False)
    ...
    def check_instructor_data(self):
        """This function read the instructors.txt
           file and fill values in self._instructors"""
        path2: str = os.path.join(self._path, "instructors.txt")
        try:
            open_file2 = file_reader(path2, fields=3, sep="\t", header=False)
    ...
    def check_grades_data(self):
        """This function read the grades.txt file and
           fill values in both self._students and self._instructors"""
        path3: str = os.path.join(self._path, "grades.txt")
        try:
            open_file3 = file_reader(path3, fields=4, sep="\t", header=False)
    ...
    def check_majors_data(self):
        """This function reads the majors.txt file and is use to
           fill the value of self.mainmajor"""
    ...
    def cal_required_elective_courses_forstudent(self):
        """This function is use to calculate required and elective courses
           left for a particular student"""
        path1: str = os.path.join(self._path, "students.txt")
        try:
            open_file1 = file_reader(path1, fields=3, sep="\t", header=False)
            for cwid, name, major in open_file1:
    ...
    def printpretty_2(self):
        """Function is use to print the prettytable of instructor summary"""
    ...
    def printpretty_3(self):
        ...
        print("Major Summary")
        p3: PrettyTable = PrettyTable(field_names=["Major",
                                                   "Required Courses",
                                                   "Electives"])
...
def main():
    Repository(r"/Users/malavshastri/Desktop")
